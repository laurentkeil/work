 ...
 * @see api.Course
 */
public class CourseWS implements api.Course, Serializable {

	 /**
	  * Référence de sérialisation
	  */
	private static final long serialVersionUID = 5263531070170173025L;
	/**
	 * id de cours
	 */
	...
	/**
	 * Constructeur de l'objet CourseWS
	 ...
	 */
	public CourseWS(String courseStr) throws Exception {
		if(!SessionWS.deco){
	...
	@Override
	public CourseTool getCourseTool() throws Exception {
		CourseTool courseTool = new CourseToolWS(getSyscode());
		return courseTool;
	}
	
	@Override
	public Annonces getAnnonces() throws Exception {
		Annonces annonces = new AnnoncesWS(getSyscode());
		return annonces;
	}
	
	@Override
	public DocsAndFolders getDocs() throws Exception {
		DocsAndFolders docs = new DocsAndFoldersWS(getSyscode());
		return docs;
	}
