 ...
 */
public class DocsAndFoldersWS implements api.DocsAndFolders, Serializable {

	 /**
	  * Référence de sérialisation
	  */
	private static final long serialVersionUID = 7641886398331311686L;
	/**
	 * code du cours
	 */
	...
	/**
	 * Constructeur de l'objet DocsAndFoldersMock / place les champs de documents ou dossiers name et/ou extension des documents ou dossiers dans leur tableau respectif.
	 ...
	 */
	public DocsAndFoldersWS(String syscode) throws Exception {
		this.syscode = syscode;

		this.domaine = "https://chouettecampus.info.fundp.ac.be/module/MOBILE/index.php?Method=";
		 
		// url pour la requête
		this.url = domaine+"getDocList&cidReq="+syscode;

			// Creating JSON Parser instance
		JsonConvertor jParser = new JsonConvertor();
			 
			// getting JSON string from URL
		JSONArray docs  = jParser.getJSONArrayFromUrl(url);
	...
	@Override
	public Doc getDoc(String name) throws Exception {
		boolean continuer = true;
		int i,empl=0;
		/*
